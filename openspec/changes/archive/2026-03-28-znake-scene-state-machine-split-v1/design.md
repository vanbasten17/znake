...
Scene State Machine Split is proposed as a focused change in the refactor track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.
...
- [Risk] Migration mistakes can break flow between scenes.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Scene State Machine Split.
...
Checked 151 files in 109ms. No fixes applied.
...
✓ built in 2.38s when behavior/architecture changes.
