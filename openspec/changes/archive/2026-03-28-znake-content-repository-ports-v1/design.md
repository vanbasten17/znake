...
Content Repository Ports is proposed as a focused change in the refactor track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.
...
- [Risk] Interface sprawl can increase boilerplate if over-applied.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Content Repository Ports.
...
Checked 151 files in 121ms. No fixes applied.
...
✓ built in 2.53s when behavior/architecture changes.
