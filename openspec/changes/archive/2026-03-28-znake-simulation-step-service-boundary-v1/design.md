...
Simulation Step Service Boundary is proposed as a focused change in the refactor track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.
...
- [Risk] Boundary churn may temporarily duplicate code paths.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Simulation Step Service Boundary.
...
Checked 151 files in 141ms. No fixes applied.
...
✓ built in 2.29s when behavior/architecture changes.
