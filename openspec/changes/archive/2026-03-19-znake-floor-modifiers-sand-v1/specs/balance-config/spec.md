...
#### Scenario: Terrain slowdown knobs are centralized

- **WHEN** gameplay resolves sand modifier activation and movement penalty
- **THEN** start floor, cadence, tile count, and penalty values are read from centralized balance config
