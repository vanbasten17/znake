...
Particle Budgeted Juice Pass is proposed as a focused change in the visual track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.

## Key Points (Codex-style)

- What is changing
  - Add particle quality tiers with deterministic budget caps per frame.
- Why we are doing it
  - Preserves juice while protecting frame stability.
- Impacted areas
  - Particle system, performance guards, settings.
- Risks / unknowns
  - Low-end tiers might feel visually flat if not art-directed.
...
- [Risk] Low-end tiers might feel visually flat if not art-directed.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Particle Budgeted Juice Pass.
...
Checked 151 files in 116ms. No fixes applied.
...
✓ built in 2.15s when behavior/architecture changes.
