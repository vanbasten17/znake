...
Pathfinding Service Extraction is proposed as a focused change in the refactor track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.
...
- [Risk] Performance regressions if allocation patterns are not controlled.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Pathfinding Service Extraction.
...
Checked 151 files in 102ms. No fixes applied.
