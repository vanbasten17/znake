...
Damage Number Legibility is proposed as a focused change in the visual track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.

## Key Points (Codex-style)

- What is changing
  - Improve damage number typography, stacking rules, and fade choreography.
- Why we are doing it
  - Helps players parse outcomes quickly during crowded combat.
- Impacted areas
  - Floating text system, font tokens, feedback timing.
- Risks / unknowns
  - Too many labels can increase noise if culling rules are weak.
...
- [Risk] Too many labels can increase noise if culling rules are weak.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Damage Number Legibility.
...
Checked 151 files in 93ms. No fixes applied.
...
✓ built in 2.16s when behavior/architecture changes.
