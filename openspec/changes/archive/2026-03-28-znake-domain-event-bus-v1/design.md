...
Domain Event Bus is proposed as a focused change in the refactor track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.
...
- [Risk] Event ordering bugs may appear without strict sequencing rules.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Domain Event Bus.
...
Checked 151 files in 142ms. No fixes applied.
