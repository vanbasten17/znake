...
HUD Visual Hierarchy Pass is proposed as a focused change in the visual track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.

## Key Points (Codex-style)

- What is changing
  - Rebalance HUD typographic scale, spacing, and grouping for scan speed.
- Why we are doing it
  - Improves readability under combat stress.
- Impacted areas
  - HUD styles, information density, accessibility contrast.
- Risks / unknowns
  - Over-reduction may remove useful contextual detail.
...
- [Risk] Over-reduction may remove useful contextual detail.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for HUD Visual Hierarchy Pass.
...
Checked 151 files in 107ms. No fixes applied.
