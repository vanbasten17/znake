...
Biome Color Script is proposed as a focused change in the visual track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.

## Key Points (Codex-style)

- What is changing
  - Define per-biome color scripts and contrast floors for route readability.
- Why we are doing it
  - Strengthens identity and reduces visual fatigue across runs.
- Impacted areas
  - Biome visuals, tile palettes, map readability.
- Risks / unknowns
  - Palette drift can conflict with accessibility presets.
...
- [Risk] Palette drift can conflict with accessibility presets.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Biome Color Script.
...
Checked 151 files in 106ms. No fixes applied.
...
✓ built in 2.20s when behavior/architecture changes.
