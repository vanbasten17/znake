...
Visual Accessibility Presets is proposed as a focused change in the visual track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.

## Key Points (Codex-style)

- What is changing
  - Provide visual presets for contrast, color-blind support, and reduced clutter.
- Why we are doing it
  - Improves inclusivity and confidence for broader player profiles.
- Impacted areas
  - Settings UX, color pipeline, HUD and VFX mapping.
- Risks / unknowns
  - Preset interactions may conflict with custom user overrides.
...
- [Risk] Preset interactions may conflict with custom user overrides.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Visual Accessibility Presets.
...
Checked 151 files in 117ms. No fixes applied.
