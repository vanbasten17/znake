...
Animation Anticipation Followthrough is proposed as a focused change in the visual track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.

## Key Points (Codex-style)

- What is changing
  - Add anticipation and follow-through timing to key snake and enemy animations.
- Why we are doing it
  - Increases responsiveness and perceived weight of actions.
- Impacted areas
  - Sprite animation timing, combat feel, camera pacing.
- Risks / unknowns
  - Timing changes can affect perceived hit windows.
...
- [Risk] Timing changes can affect perceived hit windows.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Animation Anticipation Followthrough.
...
Checked 151 files in 100ms. No fixes applied.
...
✓ built in 2.19s when behavior/architecture changes.
