...
Menu Depth Parallax is proposed as a focused change in the visual track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.

## Key Points (Codex-style)

- What is changing
  - Add subtle layered motion/parallax to menu background cards.
- Why we are doing it
  - Adds polish and perceived production quality without gameplay impact.
- Impacted areas
  - Menu background rendering, performance budgets, motion settings.
- Risks / unknowns
  - Motion sickness risk if amplitude is too high.
...
- [Risk] Motion sickness risk if amplitude is too high.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Menu Depth Parallax.
...
Checked 151 files in 90ms. No fixes applied.
...
✓ built in 2.13s when behavior/architecture changes.
