...
- [x] 1.2 Add OpenSpec spec delta for boss-encounter-depth.

## 2. Implementation

- [x] 2.1 Implement core logic for Boss Counterplay Clarity.
...
Playtest checklist:
- Verify boss cue text shows explicit window/punish wording by phase.
- Verify elite cues also surface punish-loop wording consistently.
- Verify cue labels remain stable for identical deterministic encounter states.
