...
UI ViewModel Presenter Split is proposed as a focused change in the refactor track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.
...
- [Risk] Temporary duplication while migrating old render helpers.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for UI ViewModel Presenter Split.
...
Checked 151 files in 98ms. No fixes applied.
