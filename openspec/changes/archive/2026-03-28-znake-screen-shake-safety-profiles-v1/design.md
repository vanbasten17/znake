...
Screen Shake Safety Profiles is proposed as a focused change in the visual track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.

## Key Points (Codex-style)

- What is changing
  - Create configurable screen shake profiles with low-motion presets.
- Why we are doing it
  - Keeps juice while respecting comfort and accessibility.
- Impacted areas
  - Camera effects, settings menu, accessibility profiles.
- Risks / unknowns
  - Insufficient defaults may still discomfort sensitive players.
...
- [Risk] Insufficient defaults may still discomfort sensitive players.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Screen Shake Safety Profiles.
...
✓ built in 2.18s when behavior/architecture changes.
