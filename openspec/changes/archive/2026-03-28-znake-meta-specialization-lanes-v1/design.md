...
Meta Specialization Lanes is proposed as a focused change in the gameplay track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.

## Key Points (Codex-style)

- What is changing
  - Add specialization lanes in meta progression with tradeoff-based unlock paths.
- Why we are doing it
  - Gives long-term goals and archetype identity without mandatory grind.
- Impacted areas
  - Meta progression economy, unlock UI, save data.
- Risks / unknowns
  - Lane imbalance could create dominant strategies.
...
- Anchor this change to meta-progression to simplify archive lineage.
- Rationale: reduces archive ambiguity and keeps requirement mapping clear.

## Risks / Trade-offs

- Risk: Lane imbalance could create dominant strategies.
- Trade-off: More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Meta Specialization Lanes.
