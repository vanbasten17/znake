...
Hit VFX Readability Pass is proposed as a focused change in the visual track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.

## Key Points (Codex-style)

- What is changing
  - Differentiate hit, crit, block, and dodge feedback with clear shape/color language.
- Why we are doing it
  - Improves game feel and combat feedback clarity.
- Impacted areas
  - Combat VFX, marker overlays, feedback timing.
- Risks / unknowns
  - Excessive effects may obscure hazards on dense rooms.
...
- [Risk] Excessive effects may obscure hazards on dense rooms.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Hit VFX Readability Pass.
...
Checked 151 files in 96ms. No fixes applied.
