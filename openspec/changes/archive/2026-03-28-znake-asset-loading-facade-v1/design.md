...
Asset Loading Facade is proposed as a focused change in the refactor track. The goal is to keep gameplay clarity and architecture quality aligned while enabling fast iteration.
...
- [Risk] Facade misuse can hide missing asset failures.
- [Trade-off] More granular changes increase coordination overhead but improve rollback safety.

## Migration Plan

1. Finalize spec deltas and tasks for Asset Loading Facade.
...
Checked 151 files in 149ms. No fixes applied.
