...
### Requirement: Content selectors remain deterministic and pure

The system SHALL enforce this contract as part of the znake-core-content-selector-purity-v1 scope.
