...
### Requirement: UI telemetry event names remain snake_case

The system SHALL enforce this contract as part of the znake-observability-ui-event-name-contract-v1 scope.
